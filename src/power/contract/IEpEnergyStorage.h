...
#ifndef POWER_CONTRACT_IEPENERGYSTORAGE_H
#define POWER_CONTRACT_IEPENERGYSTORAGE_H
 ...
 */
class IEpEnergyStorage : public virtual IEpEnergySource, public virtual IEpEnergySink, public virtual IEnergyStorage
{
  public:
    /**
